...
def test_audit_spec_cache_does_not_mix_power_choices() -> None:
    ...
    tesla = audit._specs_for(url, policies, "tesla")
    substation = audit._specs_for(url, policies, "substation")
...
def test_run_cell_preserves_typed_refusal_evidence(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, power_tower: (SimpleNamespace(label="evidence fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
...
def test_run_cell_persists_post_compaction_projection_failures(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, power_tower: (SimpleNamespace(label="projection fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
...
def test_run_cell_does_not_repeat_completed_placement_work(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, power_tower: (SimpleNamespace(label="completed fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
...
def test_run_cell_completes_unmarked_placement_once_and_preserves_invalid_findings(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, power_tower: (SimpleNamespace(label="ordinary fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
...
def test_run_cell_builds_the_strategy_at_the_cells_own_belt_ceiling(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, power_tower: (SimpleNamespace(label="ceiling fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
...
def test_a_raced_best_cell_is_judged_by_the_race_grace_not_the_atomic_one(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, power_tower: (SimpleNamespace(label="race grace fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
