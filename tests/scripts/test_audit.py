...
def test_run_cell_preserves_typed_refusal_evidence(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, machine_rank: (SimpleNamespace(label="evidence fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
...
def test_run_cell_does_not_repeat_completed_placement_work(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, machine_rank: (SimpleNamespace(label="completed fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
...
def test_run_cell_completes_unmarked_placement_once_and_preserves_invalid_findings(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, machine_rank: (SimpleNamespace(label="ordinary fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
...
def test_run_cell_builds_the_strategy_at_the_cells_own_belt_ceiling(
    ...
    monkeypatch.setattr(
        audit,
        "_specs_for",
        lambda url, candidate_policies, machine_rank: (SimpleNamespace(label="ceiling fixture"),),
    )
    monkeypatch.setattr(
        audit,
        "_belt_rules_for",
